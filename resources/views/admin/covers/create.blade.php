<x-admin-layout :breadcrumbs="[
    ...
    <form action="{{route('admin.covers.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <figure class="relative mb-4">
            ...
            <img src="{{asset('images/img/no-image-horizontal.png')}}" id="imgPreview" alt="Portada" class="aspect-[3/1] w-full object-cover object-center">
        </figure>
        ...
        <div class="mb-4">
            ...
            <x-input name="title" value="{{old('title')}}" class="w-full" placeholder="Ingrese un titulo"></x-input>
        </div>
        <div class="mb-4">
            <x-label>
                Fecha de inicio
        ...
        <div class="mb-4 flex space-x-2">
            <label> 
                <x-input type="radio" name="is_active" value="1" checked/>Activo
            </label>
            <label> 
                <x-input type="radio" name="is_active" value="0"/>Inactivo
            </label>
        </div>
